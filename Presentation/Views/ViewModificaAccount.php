...
class ViewModificaAccount extends ViewProfiloBase {
    ...
    // Campo età rimosso dall'interfaccia: non era gestito correttamente
    // né in lettura (mismatch con dataNascitaUtente) né in scrittura
    // (aggiornaAccount() non lo processava comunque).
