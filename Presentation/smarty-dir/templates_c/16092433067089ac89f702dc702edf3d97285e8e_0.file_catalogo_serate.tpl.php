                        ...
                        <div class="eventi-checkbox-group">
                            <label class="eventi-checkbox-label">
                                <input type="checkbox" name="tipologia[]" value="presentazione"
                                       <?php if ($_smarty_tpl->getValue('filtri')['tipologia'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('presentazione',$_smarty_tpl->getValue('filtri')['tipologia'])) {?>checked<?php }?>>
                                <span class="eventi-checkbox-text">Presentazione</span>
                            </label>
                            <label class="eventi-checkbox-label">
                                <input type="checkbox" name="tipologia[]" value="gioco_libero"
                                       <?php if ($_smarty_tpl->getValue('filtri')['tipologia'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('gioco_libero',$_smarty_tpl->getValue('filtri')['tipologia'])) {?>checked<?php }?>>
