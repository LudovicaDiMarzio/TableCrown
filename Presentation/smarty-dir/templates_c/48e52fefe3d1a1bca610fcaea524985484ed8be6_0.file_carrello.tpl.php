<?php
/* Smarty version 5.8.0, created on 2026-07-18 15:31:20
  from 'file:carrello.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_6a5b8028014739_62667932',
...
function content_6a5b8028014739_62667932 (\Smarty\Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_18878311986a5b8027f20f80_82104349', "extra_css");
?>


<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_21356369926a5b8027f25035_12976872', "content");
?>


<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_6820910106a5b8028011333_60173757', "extra_js");
?>

<?php $_smarty_tpl->getInheritance()->endChild($_smarty_tpl, "common/layout.tpl", $_smarty_current_dir);
}
/* {block "extra_css"} */
class Block_18878311986a5b8027f20f80_82104349 extends \Smarty\Runtime\Block
{
...
/* {/block "extra_css"} */
/* {block "content"} */
class Block_21356369926a5b8027f25035_12976872 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\TableCrown\\Presentation\\smarty-dir\\templates';
?>
...
"
                                 data-prezzo-unitario="<?php echo $_smarty_tpl->getValue('p')['prezzo_unitario'];?>
"
                                 data-risparmio-unitario="<?php if ($_smarty_tpl->getValue('p')['sconto']) {
echo $_smarty_tpl->getValue('p')['prezzo']-$_smarty_tpl->getValue('p')['prezzo_unitario'];
} else { ?>0<?php }?>">
...
" class="carrello-item-nome">
                                    ...
                                    <div class="carrello-item-prezzo-wrapper">
                                        <?php if ($_smarty_tpl->getValue('p')['sconto']) {?>
                                            <span class="carrello-item-prezzo">€<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('p')['prezzo_unitario'],2);?>
</span>
                                            <span class="carrello-item-prezzo-old">€<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('p')['prezzo'],2);?>
</span>
                                        <?php } elseif ((true && (true && null !== ($_smarty_tpl->getValue('p')['prezzo_unitario'] ?? null)))) {?>
                                            <span class="carrello-item-prezzo">€<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('p')['prezzo_unitario'],2);?>
</span>
                                        <?php } else { ?>
                                    ...
                                    <?php if ($_smarty_tpl->getValue('p')['sconto']) {?>
                                        <span class="carrello-item-sconto-badge">
                                            -<?php echo sprintf("%.0f",$_smarty_tpl->getValue('p')['percentuale_sconto']);?>
%
                                        </span>
                                    <?php }?>
                                </div>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                                            ...
                                            <button class="button btn-correlato-cart"
                                                    type="button"
                                                    data-product-id="<?php echo $_smarty_tpl->getValue('correlato')['id'];?>
"
...
/* {/block "content"} */
/* {block "extra_js"} */
class Block_6820910106a5b8028011333_60173757 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\TableCrown\\Presentation\\smarty-dir\\templates';
?>
...
<?php echo '<script'; ?>
>
    var CARRELLO_UPDATE_URL = "<?php echo $_smarty_tpl->getValue('base_url');
echo (($tmp = $_smarty_tpl->getValue('update_url') ?? null)===null||$tmp==='' ? '/carrello/aggiorna' ?? null : $tmp);?>
";
    var CARRELLO_REMOVE_URL = "<?php echo $_smarty_tpl->getValue('base_url');
echo (($tmp = $_smarty_tpl->getValue('remove_url') ?? null)===null||$tmp==='' ? '/carrello/rimuovi' ?? null : $tmp);?>
";
<?php echo '</script'; ?>
>
<?php echo '<script'; ?>
