                        ...
                        <div class="checkbox-group" data-exclusive="offerte">
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       name="offerte[]" 
                                       value="sconti"
                                       <?php if ((true && ($_smarty_tpl->hasVariable('offerte_filtro') && null !== ($_smarty_tpl->getValue('offerte_filtro') ?? null))) && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('sconti',$_smarty_tpl->getValue('offerte_filtro'))) {?> checked<?php }?>>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       name="offerte[]" 
                                       value="bundle"
                                       <?php if ((true && ($_smarty_tpl->hasVariable('offerte_filtro') && null !== ($_smarty_tpl->getValue('offerte_filtro') ?? null))) && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('bundle',$_smarty_tpl->getValue('offerte_filtro'))) {?> checked<?php }?>>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       name="offerte[]" 
                                       value="danneggiati"
                                       <?php if ((true && ($_smarty_tpl->hasVariable('offerte_filtro') && null !== ($_smarty_tpl->getValue('offerte_filtro') ?? null))) && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('danneggiati',$_smarty_tpl->getValue('offerte_filtro'))) {?> checked<?php }?>>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       name="offerte[]" 
                                       value="novita"
                                       <?php if ((true && ($_smarty_tpl->hasVariable('offerte_filtro') && null !== ($_smarty_tpl->getValue('offerte_filtro') ?? null))) && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('novita',$_smarty_tpl->getValue('offerte_filtro'))) {?> checked<?php }?>>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       name="offerte[]" 
                                       value="venduti"
                                       <?php if ((true && ($_smarty_tpl->hasVariable('offerte_filtro') && null !== ($_smarty_tpl->getValue('offerte_filtro') ?? null))) && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')('venduti',$_smarty_tpl->getValue('offerte_filtro'))) {?> checked<?php }?>>
