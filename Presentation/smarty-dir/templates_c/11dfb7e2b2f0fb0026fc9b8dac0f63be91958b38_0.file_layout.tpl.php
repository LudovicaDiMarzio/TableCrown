<?php
/* Smarty version 5.8.0, created on 2026-07-12 15:23:57
  from 'file:common/layout.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_6a53956d0cabf7_86884278',
...
function content_6a53956d0cabf7_86884278 (\Smarty\Template $_smarty_tpl) {
...
<head>
    ...
    <title><?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_20534841026a53956d0bed13_71509975', "page_title");
?>
</title>
...
/css/layout.css">
    ...
    <?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_19927985216a53956d0bfb08_99764601', "extra_css");
?>
...
/img/logo.png" alt="TableCrown" class="navbar-logo-img">
                    ...
                    <div class="navbar-center-links">
                        ...
                        <div class="has-catalogo-dropdown" id="catalogo-dropdown">
                                <span class="navbar-item catalogo-label<?php if ((true && ($_smarty_tpl->hasVariable('current_page') && null !== ($_smarty_tpl->getValue('current_page') ?? null))) && $_smarty_tpl->getValue('current_page') == 'catalogo') {?> is-active<?php }?>">
                                    Catalogo
                                    <i class="ti ti-chevron-down navbar-dropdown-arrow"></i>
                                </span>
                                <div class="navbar-dropdown-catalogo">
                                    <a class="navbar-item<?php if ((true && ($_smarty_tpl->hasVariable('current_subpage') && null !== ($_smarty_tpl->getValue('current_subpage') ?? null))) && $_smarty_tpl->getValue('current_subpage') == 'giochi-da-tavolo') {?> is-active<?php }?>" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/catalogo/giochi-da-tavolo">
                                        <i class="ti ti-dice-5"></i> Giochi da tavolo
                                    </a>
                                    <a class="navbar-item<?php if ((true && ($_smarty_tpl->hasVariable('current_subpage') && null !== ($_smarty_tpl->getValue('current_subpage') ?? null))) && $_smarty_tpl->getValue('current_subpage') == 'bustine') {?> is-active<?php }?>" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/catalogo/bustine">
                                        <i class="ti ti-cards"></i> Bustine
                                    </a>
                                    <a class="navbar-item<?php if ((true && ($_smarty_tpl->hasVariable('current_subpage') && null !== ($_smarty_tpl->getValue('current_subpage') ?? null))) && $_smarty_tpl->getValue('current_subpage') == 'porta-dadi') {?> is-active<?php }?>" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/catalogo/porta-dadi">
                    ...
                    <div class="navbar-end-actions">
                            ...
                            <div class="navbar-item has-dropdown" id="user-dropdown">
                                <a class="navbar-link navbar-user-link">
                                    ...
                                    <span class="navbar-username"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('utente')['nome'], ENT_QUOTES, 'UTF-8', true);?>
</span>
                                </a>
...
/profilo/eventi"><i class="ti ti-calendar"></i> I miei eventi</a>
                                    <a class="navbar-item" href="<?php echo $_smarty_tpl->getValue('base_url');?>
/profilo/recensioni"><i class="ti ti-star"></i> Le mie recensioni</a>
...
$foreach3Backup = clone $_smarty_tpl->getVariable('crumb');
?>
...
"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('crumb')['label'], ENT_QUOTES, 'UTF-8', true);?>
                        ...
                        <?php }?>
                    <?php
$_smarty_tpl->setVariable('crumb', $foreach3Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
 ...
 is-light auto-hide">
    ...
    <?php }?>
        ...
        <main>
        <?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_2069552636a53956d0c8525_03419136', "content");
?>
...
>
    ...
    <?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_18486249406a53956d0ca1a0_93173172', "extra_js");
?>
...
<?php }
/* {block "page_title"} */
class Block_20534841026a53956d0bed13_71509975 extends \Smarty\Runtime\Block
{
...
/* {/block "page_title"} */
/* {block "extra_css"} */
class Block_19927985216a53956d0bfb08_99764601 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\TableCrown\\Presentation\\smarty-dir\\templates\\common';
}
...
/* {/block "extra_css"} */
/* {block "content"} */
class Block_2069552636a53956d0c8525_03419136 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\TableCrown\\Presentation\\smarty-dir\\templates\\common';
}
...
/* {/block "content"} */
/* {block "extra_js"} */
class Block_18486249406a53956d0ca1a0_93173172 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\xampp\\htdocs\\TableCrown\\Presentation\\smarty-dir\\templates\\common';
}
