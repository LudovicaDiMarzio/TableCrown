{*
  TableCrown\Presentation\Views\Gestore - Catalogo Porta Dadi
  Estende layout_gestore.tpl.
  URL: GET /gestore/catalogo/porta-dadi (CGestore::mostraCatalogoPortaDadiGestore())

  Variabili di pagina attese:
    $prodotti => prodottiToArray() dei porta dadi
...
<div class="gprod-container">
    ...
    <div class="gprod-layout">
        ...
        <aside class="gprod-sidebar">
            ...
            <form method="get" action="{$base_url}/gestore/catalogo/porta-dadi">
                ...
                <div class="gprod-filter-actions">
                    <a class="gprod-filter-reset" href="{$base_url}/gestore/catalogo/porta-dadi">
