...
<div class="gdet-container">
    ...
    <section class="gdet-section gdet-actions">
        ...
        {if $stato == 'annullato'}
            {* ── PANNELLO: Riprogramma (unico modo per cambiare la data) ── *}
...
<script>
    ...
    {if $stato == 'annullato'}
    // Converte 'YYYY-MM-DDTHH:MM' (input datetime-local) in 'YYYY-MM-DD HH:MM:SS'
    // atteso da riprogrammaEventoGestore() lato Control.
    (function() {
