{*
  TableCrown\Presentation\Views\Gestore - Modifica Prodotto (Bustine)
  Estende layout_gestore.tpl.
  Identico a gestore_modifica_gioco.tpl ma SENZA la sezione danno, perché
  aggiungiDanno()/EDanno è concettualmente legato solo a EGiocoDaTavolo
  (vedi modificaProdottoGestore(): il blocco danneggiato è dentro
